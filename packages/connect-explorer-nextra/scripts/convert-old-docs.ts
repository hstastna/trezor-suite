...
`;
    ...
    if (subdirectory) {
        fs.mkdirSync(path.join(__dirname, `../src/pages/generated/`, subdirectory), {
            recursive: true,
        });
    }
    ...
    try {
        ...
        fs.unlinkSync(path.join(__dirname, `../src/pages/generated/${filename}.mdx`));
    }
}
