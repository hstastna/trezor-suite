import { SolanaSignTransaction } from '@trezor/connect/src/types/api/solana';
...
<ApiPlayground
    options={[
        {
            title: 'SolanaSignTransaction',
            method: 'solanaSignTransaction',
            schema: SolanaSignTransaction,
        },
    ]}
/>

export const paramDescriptions = {
    path: 'minimum length is `2`. [read more](../path.md)',
    serializedTx: '',
};
...
<ParamsTable schema={SolanaSignTransaction} descriptions={paramDescriptions} />
