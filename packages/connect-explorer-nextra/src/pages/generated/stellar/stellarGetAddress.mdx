...
<ApiPlayground
    options={[
        { title: 'GetAddress', method: 'stellarGetAddress', schema: GetAddress },
        { title: 'Bundle(GetAddress)', method: 'stellarGetAddress', schema: Bundle(GetAddress) },
    ]}
/>

export const paramDescriptions = {
    path: 'minimum length is `3`. [read more](../path.md)',
