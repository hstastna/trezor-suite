import { TezosSignTransaction } from '@trezor/connect/src/types/api/tezos';
...
<ApiPlayground
    options={[
        {
            title: 'TezosSignTransaction',
            method: 'tezosSignTransaction',
            schema: TezosSignTransaction,
        },
    ]}
/>
...
export const paramDescriptions = {
    ...
    branch: '',
    operation:
        'type of [TezosOperation](https://github.com/trezor/trezor-suite/blob/develop/packages/connect/src/types/api/tezos/index.ts)',
    chunkify:
...
<ParamsTable schema={TezosSignTransaction} descriptions={paramDescriptions} />
