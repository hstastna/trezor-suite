...
<ApiPlayground
    options={[
        { title: 'GetOwnershipProof', method: 'getOwnershipProof', schema: GetOwnershipProof },
        {
            title: 'Bundle(GetOwnershipProof)',
...
export const paramDescriptions = {
    path: 'minimum length is `5`. [read more](../path.md)',
    coin: '',
    scriptType: '',
    userConfirmation: '',
    ownershipIds: '',
    commitmentData: '',
    multisig: '',
    preauthorized: '[read more](./authorizeCoinjoin.md)',
