...
} from '@trezor/connect/src/types/api/cardano';
    ...
    options={[
        {
            ...
            schema: CardanoSignTransaction,
        },
        {
            title: 'CardanoSignTransactionExtended',
            method: 'cardanoSignTransaction',
            schema: CardanoSignTransactionExtended,
        },
    ]}
/>

export const paramDescriptions = {
    inputs: 'of [CardanoInput](https://github.com/trezor/trezor-suite/blob/develop/packages/connect/src/types/api/cardano/index.ts)',
    outputs:
        'of [CardanoOutput](https://github.com/trezor/trezor-suite/blob/develop/packages/connect/src/types/api/cardano/index.ts)',
    fee: '',
    ...
    certificates:
        'of [CardanoCertificate](https://github.com/trezor/trezor-suite/blob/develop/packages/connect/src/types/api/cardano/index.ts)',
    withdrawals:
        'of [CardanoWithdrawal](https://github.com/trezor/trezor-suite/blob/develop/packages/connect/src/types/api/cardano/index.ts)',
    scriptDataHash: '',
    collateralInputs:
        'of [CardanoCollateralInput](https://github.com/trezor/trezor-suite/blob/develop/packages/connect/src/types/api/cardano/index.ts)',
    requiredSigners:
        'of [CardanoRequiredSigner](https://github.com/trezor/trezor-suite/blob/develop/packages/connect/src/types/api/cardano/index.ts)',
    totalCollateral: '',
    referenceInputs:
        'of [CardanoReferenceInput](https://github.com/trezor/trezor-suite/blob/develop/packages/connect/src/types/api/cardano/index.ts)',
    additionalWitnessRequests:
        'of `string | Array<number>` (paths). Used for multi-sig and token minting witness requests as those can not be determined from the transaction parameters.',
    metadata: 'instead',
...
<ParamsTable schema={CardanoSignTransaction} descriptions={paramDescriptions} />
#### CardanoSignTransactionExtended

<ParamsTable schema={CardanoSignTransactionExtended} descriptions={paramDescriptions} />
