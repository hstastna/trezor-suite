...
<ApiPlayground
    options={[
        { title: 'GetPublicKey', method: 'getPublicKey', schema: GetPublicKey },
        { title: 'Bundle(GetPublicKey)', method: 'getPublicKey', schema: Bundle(GetPublicKey) },
    ]}
/>

export const paramDescriptions = {
    path: 'minimum length is `1`. [read more](../path.md)',
